...
var memberlist;
	function search(){
		...
		var wore = document.getElementById("word").value;
	...
	function makeList(data){
		...
		for(var i=0;i<len;i++){
			var member = members.item(i); // members[i]
	...
	function createCol(data){
		var id = document.createElement("td"); //<td></td>
		td.setAttribute("bgcolor", "lightgrey") //<td bgcolor="lightgrey"></td>
