...
<c:if test="${article != null}">
	<script>
		...
		$(document).on("click", ".mModifyCannelBtn", function() {
			$(this).parents("tr").attr("style", "display:none;");
		...
		function makeList(memos) {
			...
			for (var i = 0; i < memocnt; i++) {
				...
				viewlist += "	<td width=\"100\" style=\"padding-left: 14px\">"
						+ memo.name + "</td>";
				...
				viewlist += "		<textarea id=\"modifycontent"+memo.mseq+"\" rows=\"4\" cols=\"170\">"
						+ memo.mcontent + "</textarea>";
				viewlist += "	</td>";
				viewlist += "	<td>";
				viewlist += "		<input type=\"button\" class=\"mModifyBtn\" value=\"수정\">";
				viewlist += "		<input type=\"button\" class=\"mModifyCannelBtn\" value=\"취소\">";
				viewlist += "	</td>";
				viewlist += "</tr>";
				viewlist += "<tr>";
		...
		<form name="bbsForm" id="bbsbbs" method="post">
			...
			<tr>
				<td valign="bottom" nowrap><img
					src="${root}/img/board/btn_write_01.gif" class="writeBtn"
				...
				<td align="right" nowrap valign="bottom"><label class="newlist">최신목록</label><font
					color="#c5c5c5">|</font> <label class="prelist">목록</label><font
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr valign="top">
			<td nowrap><img src="${root}/img/board/btn_write_01.gif"
				class="writeBtn" width="64" height="22" border="0" align="absmiddle"
				alt="글쓰기"> <img src="${root}/img/board/btn_reply.gif"
				class="replyBtn" width="40" height="22" border="0" align="absmiddle"
				alt="답글"></td>
			...
			<td align="right" nowrap><label class="newlist">최신목록</label><font
				color="#c5c5c5">|</font> <label class="prelist">목록</label><font
				color="#c5c5c5">|</font> <font color="#c5c5c5">|</font> <a
				href="javascript:goBbsRead();"><img
					src="${root}/img/board/icon_up.gif" border="0" align="absmiddle"
					hspace="3">윗글</a> <font color="#c5c5c5">|</font> <a
				href="javascript:goBbsRead();">아랫글<img
					src="${root}/img/board/icon_down.gif" border="0" align="absmiddle"
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td colspan="3" height="30" style="padding: 10px"><textarea
					id="mcontent" rows="4" cols="170"></textarea></td>
			<td><c:if test="${userInfo != null}">
