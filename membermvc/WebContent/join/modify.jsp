...
<html>
	<head>
		...
		<link rel="stylesheet" href="<%=root%>/css/style.css" type="text/css"> <!--"/memberservlet/css/style.css"-->
		<script type="text/javascript">
			...
			function join(){
				...
				if(document.getElementById("name").value.trim().length == 0){
					...
					document.getElementById("joinform").setAttribute("action","<%=root%>/user");
...
<body>
	<div class="testbox box1">
		...
		<input type="text" name="id" id="id" value="<%=memberDetailDto.getId()%>" size="12" placeholder="ID"  required readonly="readonly"/>
