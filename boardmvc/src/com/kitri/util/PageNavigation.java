...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		tmpNavigator.append("   <table cellpadding='5' cellspacing='5' border='0'>\n");
		tmpNavigator.append("    <tr>\n");
		tmpNavigator.append("     <td width='10' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
		...
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				...
				tmpNavigator.append("     <td width='10' nowrap><img src='" + root + "/img/board/n_tab.gif' width='2'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			} else {
				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><span class='pglist' move-pg='"+ i +"'>" + i + "</td></span>\n");
				tmpNavigator.append("     <td width='10' nowrap><img src='" + root + "/img/board/n_tab.gif' width='2'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			}
		}
