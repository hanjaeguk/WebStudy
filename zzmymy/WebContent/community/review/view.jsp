									...
									<div class="col-md-12 nav-link-wrap mb-5">
										<div class="nav ftco-animate nav-pills" id="v-pills-tab"
											...
											<a class="nav-link active" id="v-pills-whatwedo-tab"
												...
												aria-controls="v-pills-whatwedo" aria-selected="true">글목록</a> <a
												class="nav-link" id="v-pills-mission-tab" data-toggle="pill"
												href="#v-pills-mission" role="tab" aria-controls="v-pills-mission"
												aria-selected="false">윗글</a> <a class="nav-link"
												id="v-pills-goal-tab" data-toggle="pill" href="#v-pills-goal"
												role="tab" aria-controls="v-pills-goal" aria-selected="false">아랫글</a>
										</div>
									</div>
